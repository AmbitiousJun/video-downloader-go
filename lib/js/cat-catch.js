...
(function () {
    ...
    resourceContainer.innerText = '[]';
    resourceContainer.setAttribute('id', 'cat-catch-result');
    window.onload = () => document.body.appendChild(resourceContainer);
    ...
    function postData(data) {
        ...
        const currentDatas = JSON.parse(resourceContainer.innerText);
        currentDatas.push(data);
        resourceContainer.innerText = JSON.stringify(currentDatas);
